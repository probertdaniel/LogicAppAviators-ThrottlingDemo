...
Param(
    ...
    [string] $ResourceGroupName = 'RUK.Integration.Common.ResourceGroups',
...
if ($ValidateOnly) {
    $ErrorMessages = Format-ValidationOutput (Test-AzDeployment -ResourceGroupName $ResourceGroupName `
