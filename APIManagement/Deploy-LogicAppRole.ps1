...
The Azure subscription ID where the role is to be created.

.PARAMETER role
The name of the role.

.EXAMPLE
./Deploy-LogicAppRole.ps1 -subscriptionId "<azure-subs-id>" -role "Get Logic App Callback Url xxxxx"
#>
...
$roleDefinition = Get-Content -Raw -Path "$PSScriptRoot\Roles\RoutingManager.logicappsrole.json" | ConvertFrom-Json
